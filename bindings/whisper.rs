...
extern "C" {
  pub fn ggml_new_tensor_1d(ctx: *mut ggml_context, type_: ggml_type, ne0: i64)
    -> *mut ggml_tensor;
}
extern "C" {
...
extern "C" {
  pub fn ggml_gelu_quick_inplace(ctx: *mut ggml_context, a: *mut ggml_tensor) -> *mut ggml_tensor;
}
extern "C" {
...
extern "C" {
  pub fn ggml_reshape_1d(ctx: *mut ggml_context, a: *mut ggml_tensor, ne0: i64)
    -> *mut ggml_tensor;
}
extern "C" {
...
pub type ggml_custom2_op_f32_t = ::std::option::Option<
  unsafe extern "C" fn(arg1: *mut ggml_tensor, arg2: *const ggml_tensor, arg3: *const ggml_tensor),
>;
...
extern "C" {
  pub fn ggml_graph_plan(cgraph: *mut ggml_cgraph, n_threads: ::std::os::raw::c_int) -> ggml_cplan;
}
extern "C" {
...
fn bindgen_test_layout_whisper_context_params() {
  const UNINIT: ::std::mem::MaybeUninit<whisper_context_params> = ::std::mem::MaybeUninit::uninit();
  let ptr = UNINIT.as_ptr();
  assert_eq!(
...
fn bindgen_test_layout_whisper_full_params() {
  ...
  assert_eq!(
    unsafe { ::std::ptr::addr_of!((*ptr).new_segment_callback_user_data) as usize - ptr as usize },
    152usize,
    concat!(
      "Offset of field: ",
      stringify!(whisper_full_params),
